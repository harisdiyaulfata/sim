...
<div class="row">
	<div class="col-md-6">
		...
		<div class="form-group">
			...
			<input type="text" name="level" class="form-control" value="<?php echo $user->level ?>" readonly>
		</div>
	</div>
	<div class="col-md-6">
		<div class="form-group">
		...
		<div class="form-group">
			<input type="submit" name="submit" class="btn btn-primary btn-xm float-right" value="Update">
		</div>
	</div>
</div>
